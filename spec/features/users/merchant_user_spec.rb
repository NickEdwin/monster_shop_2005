...
RSpec.describe "as a merchant level user" do
  describe "it views any page" do
    it "and sees additonal link to merchant dashboard" do
      ...
      user = User.create!(name: "Nick", email: "12345@gmail.com", password: "password", role: 2, merchant_id: merchant1.id)
  ...
  describe "it visits its dashboard" do
    ...
    @user = User.create!(name: "Nick", email: "12311145@gmail.com", password: "password", role: 2, merchant_id: @merchant1.id)
    @address = UserAddress.create!(address: "123 Main St", city: "Denver", state: "CO", zip: "80439", user_id: @user.id)
  ...
  describe "in the merchant dashboard, i see any pending orders for my store" do
    it "i also see details of the pending orders" do
      @user1 = User.create!(name: "Nick", email: "12345@gmail.com", password: "password", role: 1)
      @address1 = UserAddress.create!(address: "123 Main St", city: "Denver", state: "CO", zip: "80439", user_id: @user1.id)
      ...
      @order_1 = Order.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, status: "shipped", user_id: @user1.id)

      @order_1.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)
      @order_1.item_orders.create!(item: @paper, price: @paper.price, quantity: 3)

      @user_2 = User.create!(name: "Nick", email: "123456@gmail.com", password: "password", role: 1)
      ...
      @user_3 = User.create!(name: "Nick", email: "1234567@gmail.com", password: "password", role: 1)
      ...
      @user_4 = User.create!(name: "Nick", email: "12345678@gmail.com", password: "password", role: 1)
      @address4 = UserAddress.create!(address: "123 Main St", city: "Denver", state: "CO", zip: "80439", user_id: @user_4.id)

      @order_4 = Order.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, status: "pending", user_id: @user_4.id, order_total: 60)
      ...
      @user_5 = User.create!(name: "Nick", email: "1@gmail.com", password: "password", role: 1)
      @address5 = UserAddress.create!(address: "123 Main St", city: "Denver", state: "CO", zip: "80439", user_id: @user_5.id)

      @order_5 = Order.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, status: "pending", user_id: @user_5.id, order_total: 160)

      @order_5.item_orders.create!(item: @paper, price: @paper.price, quantity: 8, merchant_id: @merchant1.id)

      @user = User.create!(name: "Nick", email: "12345z@gmail.com", password: "password", role: 2, merchant_id: @merchant1.id)
      @address6 = UserAddress.create!(address: "123 Main St", city: "Denver", state: "CO", zip: "80439", user_id: @user.id)
